                ...
                <main className="mx-auto max-w-4xl px-6 py-16">
                    ...
                    <div className="mt-8 space-y-6 text-sm text-slate-300 leading-relaxed font-light">
                        <section className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 space-y-3">
                            ...
                            <p>
                                We offer a 14-day money-back guarantee for unused AI token packs (€1 = 1 token) purchased via Credit/Debit Card or Direct Bank Transfer on our website.
                            </p>
                        </section>

                        <section className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 space-y-3">
                            <h2 className="text-lg font-bold text-white">2. Refund Eligibility Conditions</h2>
                            <p>
                                If you have purchased an AI token pack and have not consumed any tokens from that specific pack, you are eligible for a 100% full refund within 14 days of purchase.
                            </p>
                        </section>
                        ...
                        <section className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 space-y-3">
                            ...
                            <p>
                                To request a refund, please send your transaction reference code (`FN-XXXX`) and order details to billing@fitninja.co.uk. Refunds are processed within 3-5 business days back to your original payment method.
                            </p>
                        </section>
                    </div>
                </main>
