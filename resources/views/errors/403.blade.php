...
<head>
    ...
    <title>403 — Restricted Medical Section | FitNinja AI</title>
...
<body class="bg-[#070A11] text-slate-100 font-sans antialiased min-h-screen flex flex-col justify-between selection:bg-emerald-500 selection:text-white">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-40 -left-40 h-[500px] w-[500px] rounded-full bg-amber-600/15 blur-[160px]"></div>
    </div>
    ...
    <main class="relative z-10 mx-auto flex max-w-3xl flex-1 flex-col items-center justify-center px-6 py-20 text-center">
        <div class="relative mb-6">
            <img src="/images/logo.png" alt="FitNinja AI Logo" class="h-28 w-28 rounded-3xl border border-amber-500/40 shadow-[0_0_35px_rgba(245,158,11,0.4)]">
        </div>

        <div class="inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-xs font-black uppercase tracking-widest text-amber-400 mb-4">
            ⚡ Status 403
        </div>

        <h1 class="text-4xl font-black tracking-tight text-white sm:text-5xl">
            403 — <span class="bg-gradient-to-r from-amber-400 via-emerald-300 to-teal-400 bg-clip-text text-transparent">Restricted Medical Section</span>
        </h1>

        <p class="mt-4 max-w-xl text-base text-slate-400 leading-relaxed font-light">
            Access restricted to unauthorized users. High-level executive authorization is required.
        </p>
